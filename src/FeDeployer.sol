...
library FeDeployer {
    ...
    // @notice Deterministically create a new Fe config using create2 and a salt
    function config_with_create_2(uint256 salt) public returns (FeConfig) {
        return new FeConfig{salt: bytes32(salt)}();
    }
